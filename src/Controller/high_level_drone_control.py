...
def odomfunc(odom):
	...
	velocities[2] = odom.car_state.twist.twist.linear.z
...
def vfunc(odom_d):
	...
	vel_drones[2] = odom_d.twist.twist.linear.z
...
def main():
	...
	while not rospy.is_shutdown():
		vel = (KP*((positions-pos_drones).T)) + KD*((velocities-vel_drones).T)
		print(vel)
		msg = Twist()
		msg.linear.x,msg.linear.y,msg.linear.z = vel[0], vel[1], vel[2]

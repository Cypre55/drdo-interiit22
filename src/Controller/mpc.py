...
def pathfunc():	
	...
	if flag == 0:
		...
		if total_path_points == 0:
			...
			path = np.load("/home/satwik/catkin_ws/src/drdo-interiit22/src/Controller/ugv_waypoints.npy")
...
def my_mainfunc():
	...
	nlp_prob ={/home/rohit_dhamija/InterIIT22_ws/src/drdo_interiit22/src/Controller/ugv_waypoints.npy
			'f':obj,
			'x':OPT_variables,
			'g':g,
			'p':P
